(function ($) {
    ...
    $(document).ready(function () {
        const calculateSlidesToShow_v3 = () => Math.max(Math.floor($('.repocean-slider-main-v3 .right').width() / 305), 1);
        const initializeSlider_v3 = () => {
            const slidesToShow_v3 = calculateSlidesToShow_v3();
            $('.repocean-slider-main-v3 .slider-box-parent').slick({
                dots: false,
                autoplay: true,
                infinite: true,
                autoplaySpeed: 6100,
                ...
                speed: 700,
                slidesToShow: slidesToShow_v3,
                slidesToScroll: 1,
                variableWidth: false,
                arrows: repocean_slider_js_v3.arrowVisibility === 'true'
            });
        };
        const refreshReadMore = () => {
            $('.repocean-slider-main-v3 .slider-box-inner').each(function () {
        ...
        setTimeout(() => {
            ...
            $('.repocean-slider-main-v3 .repocean-content-wrapper').css('visibility', 'visible');
            refreshReadMore();
        }, 1);
        initializeSlider_v3();
        $(window).on('resize', () => {
            $('.repocean-slider-main-v3 .slider-box-parent').slick('unslick');
            initializeSlider_v3();
            refreshReadMore();
        });
    });

    $('.repocean-slider-main-v3').on('click', '.button-content .rep-button a', function (event) {
